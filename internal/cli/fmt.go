...
// formatFile rewrites a parsed Runefile in canonical form: settings, then
// assignments, then tasks in declaration order, bodies indented four spaces.
func formatFile(f *ast.File) string {
